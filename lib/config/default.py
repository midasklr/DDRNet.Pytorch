...
_C.TRAIN.RANDOM_BRIGHTNESS = True
_C.TRAIN.RANDOM_BRIGHTNESS_SHIFT_VALUE = 20
...
_C.TRAIN.HUE = True
_C.TRAIN.RANDOM_HUE_VALUE = (-0.01, 0.01)
_C.TRAIN.SATURATION = True
_C.TRAIN.RANDOM_SAT_VALUE = (0.95, 1.05)
_C.TRAIN.CONTRAST = True
_C.TRAIN.RANDOM_CONTRAST_VALUE = (0.9, 1.1)
_C.TRAIN.RANDOM_ROTATE = True
_C.TRAIN.RANDOM_ROTATE_ANGLE = 20
